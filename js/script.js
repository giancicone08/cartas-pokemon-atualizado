function pesquisarCartas() {
    var nomeDaCarta = document.getElementById("inpuTtext").value;
  ...
  function mostrarCartas(data) {
    var respostaAPI = document.getElementById("respostaAPI");
    respostaAPI.innerHTML = "";
  
    if (data.data.length === 0) {
        respostaAPI.innerHTML = "<p>Nenhuma carta encontrada.</p>";
      return;
    }
    ...
    data.data.forEach(carta => {
      ...
      respostaAPI.appendChild(cartaDiv);
    });
  }
